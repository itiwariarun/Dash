...
<div class='h-[24rem] min-w-full truncate bg-gradient-light'>
               <div class=' columns-4 container space-x-10  h-[20rem] text-center px-20 pt-[3rem] min-w-full '>
                <div class='truncate h-[16rem]'> <a href="{{url('/home')}}" >
                   <h1 class="pt-7 pl-28 m-0 truncate font-serif font-semibold text-xl text-stone-900 text-uppercase">Hooks Form</h1>
               </a></div>
           ...
           <p className='pb-1 font-black text-center'>@ Copyright by XYZ</p>
